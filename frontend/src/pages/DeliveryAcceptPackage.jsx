...
const DeliveryAcceptPackages = () => {
    ...
    const fetchSellerOrders = (searchTerm, setLoading, setOrders) => {
        ...
        let url = '/delivery-package-orders/ACCEPT';
        if (searchTerm) {
        ...
        Swal.fire({
            ...
            preConfirm: () => {
                return new Promise((resolve) => {
                    ...
                    axios.post('/send-mail/package/PICKED_UP', JSON.stringify(requestData), {
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': `Token ${storeData.token}`,
                        },
...
export default DeliveryAcceptPackages;