...
const DeliveryDeliverPackage = () => {
    ...
    const fetchSellerOrders = (searchTerm, setLoading, setOrders) => {
        ...
        let url = '/delivery-package-orders/PICKED_UP';
        if (searchTerm) {
...
// Call fetchSellerOrders when needed, passing the searchTerm, setLoading, and setOrders functions as arguments
    ...
    const handleSubmitDeliverOrder = (data) => {
        Swal.fire({
            title: "Are you sure?",
            text: "Do you want to deliver the packages?",
            icon: "question",
            ...
            preConfirm: () => {
                return new Promise((resolve) => {
                    ...
                    axios.post('/send-mail/package/DELIVERED', JSON.stringify(requestData), {
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': `Token ${storeData.token}`,
                        },
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                axios.post('/status-change/', JSON.stringify(requestData), {
                                    ...
                                    fetchSellerOrders(searchTerm, setLoading, setOrders);
                                    Swal.fire("Package has been delivered by you!", "", "success");
                                }).catch((err) => {
                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2 text-center">
                            <div class="breadcrumb-text">
                                <p>Collect Packages</p>
                                <h1>Pending Package To Receive</h1>
                            </div>
                        </div>
                    </div>
                </div>
...
export default DeliveryDeliverPackage;