...
const SellerPackageOrders = () => {
    ...
    const fetchPackageOrders = (searchTerm, setLoading, setOrders) => {
        setLoading(true);
        const config = {
            headers: {
    ...
    const handleSubmitOrder = async (data) => {
        try {
            ...
            setLoading(false)
            toast.success('Product request sent to deliveryman!')
        } catch (e) {
            setLoading(false);
                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2 text-center">
                            <div class="breadcrumb-text">
                                <p>Manage Package Orders</p>
                                <h1>Pending Package Orders</h1>
                            </div>
                        </div>
                    </div>
                </div>
...
export default SellerPackageOrders;